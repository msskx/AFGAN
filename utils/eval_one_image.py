...
from utils.Metric import ssim, EN_function, MI_function, SD_function, SF_function, PSNR_function, AG_function, MSE_function, \
...
if __name__ == '__main__':
    f_name = r'/ML/Mashuai/GAN/AFGAN/dataset/test/FUYU/ir/1.jpg'
    ir_name = r'/ML/Mashuai/GAN/AFGAN/dataset/test/FUYU/ir/1.jpg'
    vi_name = r'/ML/Mashuai/GAN/AFGAN/dataset/test/FUYU/vi/1.jpg'
